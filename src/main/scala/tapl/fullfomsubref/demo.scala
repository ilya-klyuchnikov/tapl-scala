...
class FullFomSubRefDemo extends util.Demo {
  ...
  override val name: String = "FullFomSubRef"
...
object FullFomSubRefDemo extends FullFomSubRefDemo with util.DemoCL
object FullFomSubRefDemoJS extends FullFomSubRefDemo with util.DemoJS
