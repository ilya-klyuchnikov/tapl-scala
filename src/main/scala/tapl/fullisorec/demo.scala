...
class FullIsorecDemo extends util.Demo {
  ...
  override val name: String = "FullIsorec"
...
object FullIsorecDemo extends FullIsorecDemo with util.DemoCL
object FullIsorecDemoJS extends FullIsorecDemo with util.DemoJS
