...
class FullEquirecDemo extends util.Demo {
  ...
  override val name: String = "FullEquirec"
...
object FullEquirecDemo extends FullEquirecDemo with util.DemoCL
object FullEquirecDemoJS extends FullEquirecDemo with util.DemoJS
