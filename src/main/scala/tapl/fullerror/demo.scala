...
class FullErrorDemo extends util.Demo {
  ...
  override val name: String = "FullError"
...
object FullErrorDemo extends FullErrorDemo with util.DemoCL
object FullErrorDemoJS extends FullErrorDemo with util.DemoJS
