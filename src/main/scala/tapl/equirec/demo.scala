...
class EquirecDemo extends util.Demo {
  ...
  override val name: String = "Equirec"
...
object EquirecDemo extends EquirecDemo with util.DemoCL
object EquirecDemoJS extends EquirecDemo with util.DemoJS
